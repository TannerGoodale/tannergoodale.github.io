            ...
            if(towns[i].name == townNames[x]){
                ...
                var img = document.createElement("img");
                    if(towns[i].name == townNames[0]){
                        img.src = "../../weathersite/images/fish_haven-_idaho_8-2011_-6842(opt).jpg";
                    }
                    else if(towns[i].name == townNames[2]){
                        img.src = "../../weathersite/images/1122957169_64db139c48_b (opt).jpg";
                    }
                    else if(towns[i].name == townNames[1]){
                        img.src = "../../weathersite/images/soda-springs-1768616_960_720 (opt).jpg";
                    }
